...
struct PolyType PolyList[ 45 ] = {
  { "goblin", 4, 201 }, /* 1 */
  { "parrot", 4, 9001 },      { "frog", 4, 215 },
  { "orc", 5, 4005 },         { "trog", 5, 219 },
  { "gnoll", 6, 211 },        { "parrot", 6, 9010 },
  { "lizard", 6, 224 },       { "ogre", 8, 4113 },
  { "parrot", 8, 9011 },      { "wolf", 8, 3094 }, /* 10 */
  { "spider", 9, 227 },       { "beast", 9, 242 },
  { "minotaur", 9, 247 },     { "snake", 10, 249 },
  { "bull", 10, 1008 },       { "warg", 10, 6100 },
  { "rat", 11, 7002 },        { "sapling", 12, 1421 },
  { "ogre-maji", 12, 257 },   { "black", 12, 230 }, /* 20 */
  { "troll", 14, 4101 },      { "crocodile", 14, 5310 },
  { "mindflayer", 14, 7202 }, { "giant", 16, 261 },
  { "bear", 16, 9024 },       { "blue", 16, 233 },
  { "enfan", 18, 21001 },     { "lamia", 18, 5201 },
  { "drider", 18, 5011 },     { "wererat", 19, 7203 }, /* 30 */
  { "wyvern", 20, 3415 },     { "mindflayer", 20, 7201 },
  { "spider", 20, 20010 },    { "snog", 22, 27008 },
  { "roc", 22, 3724 },        { "mud", 23, 7000 },
  { "enfan", 23, 21004 },     { "white", 26, 243 },
  { "master", 28, 7200 },     { "red", 30, 7040 }, /* 40 */
  { "roo", 35, 27411 },       { "brontosaurus", 35, 21802 },
...
void cast_resurrection(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious problem in 'resurrection'");
    break;
  }
}
...
void cast_major_track(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious problem in 'track'");
    break;
  }
}
...
void cast_armor(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("Serious screw-up in armor!");
    break;
  }
}
...
void cast_stone_skin(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("Serious screw-up in stone_skin!");
    break;
  }
}
...
void cast_astral_walk(byte level, struct char_data *ch, char *arg, int type,
  ...
  default:
    debug("Serious screw-up in astral walk!");
    break;
  }
}
...
void cast_teleport(byte level, struct char_data *ch, char *arg, int type,
  ...
  default:
    debug("Serious screw-up in teleport!");
    break;
  }
}
...
void cast_bless(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("Serious screw-up in bless!");
    break;
  }
}
...
void cast_infravision(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in infravision!");
    break;
  }
}
...
void cast_true_seeing(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in true_seeing!");
    break;
  }
}
...
void cast_blindness(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in blindness!");
    break;
  }
}
...
void cast_light(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("Serious screw-up in light!");
    break;
  }
}
...
void cast_cont_light(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("Serious screw-up in continual light!");
    break;
  }
}
...
void cast_control_weather(byte level, struct char_data *ch, char *arg, int type,
  ...
  default:
    debug("Serious screw-up in control weather!");
    break;
  }
}
...
void cast_create_food(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in create food!");
    break;
  }
}
...
void cast_create_water(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in create water!");
    break;
  }
}
...
void cast_water_breath(byte level, struct char_data *ch, char *arg, int type,
  ...
  default:
    debug("Serious screw-up in water breath");
    break;
  }
}
...
void cast_heroes_feast(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in heroes feast");
    break;
  }
}
...
void cast_cure_blind(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in cure blind!");
    break;
  }
}
...
void cast_cure_critic(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in cure critic!");
    break;
  }
}
...
void cast_cure_light(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in cure light!");
    break;
  }
}
...
void cast_cure_serious(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in cure serious!");
    break;
  }
}
...
void cast_refresh(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in refresh!");
    break;
  }
}
...
void cast_second_wind(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in second_wind!");
    break;
  }
}
...
void cast_shield(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in shield!");
    break;
  }
}
...
void cast_detect_evil(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in detect evil!");
    break;
  }
}
...
void cast_detect_invisibility(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in detect invisibility!");
    break;
  }
}
...
void cast_detect_magic(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in detect magic!");
    break;
  }
}
...
void cast_detect_poison(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in detect poison!");
    break;
  }
}
...
void cast_dispel_evil(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in dispel evil!");
    break;
  }
}
...
void cast_dispel_good(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in dispel good!");
    break;
  }
}
...
void cast_enchant_weapon(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in enchant weapon!");
    break;
  }
}
...
void cast_enchant_armor(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in enchant armor!");
    break;
  }
}
...
void cast_heal(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in heal!");
    break;
  }
}
...
void cast_invisibility(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in invisibility!");
    break;
  }
}
...
void cast_locate_object(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in locate object!");
    break;
  }
}
...
void cast_poison(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in poison!");
    break;
  }
}
...
void cast_protection_from_evil(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in protection from evil!");
    break;
  }
}
...
void cast_remove_curse(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in remove curse!");
    break;
  }
}
...
void cast_remove_poison(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in remove poison!");
    break;
  }
}
...
void cast_remove_paralysis(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in remove paralysis!");
    break;
  }
}
...
void cast_sanctuary(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in sanctuary!");
    break;
  }
}
...
void cast_fireshield(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in fireshield!");
    break;
  }
}
...
void cast_sleep(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in sleep!");
    break;
  }
}
...
void cast_strength(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in strength!");
    break;
  }
}
...
void cast_ventriloquate(byte level, struct char_data *ch, char *arg, int type,
  ...
  if (type != SPELL_TYPE_SPELL) {
    debug("Attempt to ventriloquate by non-cast-spell.");
    return;
  }
  for (; *arg && (*arg == ' '); arg++)
    ;
...
void cast_word_of_recall(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in word of recall!");
    break;
  }
}
...
void cast_summon(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in summon!");
    break;
  }
}
...
void cast_charm_person(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in charm person!");
    break;
  }
}
...
void cast_charm_monster(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in charm monster!");
    break;
  }
}
...
void cast_sense_life(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in sense life!");
    break;
  }
}
...
void cast_identify(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in identify!");
    break;
  }
}
...
struct pbreath {
  ...
  { 3970, { 201, 0 } }, { 3971, { 202, 0 } }, { 3972, { 203, 0 } },
  { 3973, { 204, 0 } }, { 3974, { 205, 0 } }, { 0 },
};
...
void cast_dragon_breath(byte level, struct char_data *ch, char *arg, int type,
  ...
  for (i = 0; i < MAX_BREATHS && scan->spell[ i ]; i++) {
    if (!affected_by_spell(ch, scan->spell[ i ])) {
      ...
      if (GET_CON(ch) < 4) {
        send_to_char("You are too weak to stomach the potion and spew it all "
                     "over the floor.\n\r",
                     ch);
      ...
      if (level > MIN(GET_CON(ch) - 1, GetMaxLevel(ch))) {
        send_to_char("!GACK! You are too weak to handle the full power of the "
                     "potion.\n\r",
                     ch);
...
void cast_fire_breath(byte level, struct char_data *ch, char *arg, int type,
  ...
  default:
    debug("Serious screw-up in firebreath!");
    break;
  }
}
...
void cast_frost_breath(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break; /* It's a spell.. But people can'c cast it! */
  default:
    debug("Serious screw-up in frostbreath!");
    break;
  }
}
...
void cast_acid_breath(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break; /* It's a spell.. But people can'c cast it! */
  default:
    debug("Serious screw-up in acidbreath!");
    break;
  }
}
...
void cast_gas_breath(byte level, struct char_data *ch, char *arg, int type,
  ...
  /* THIS ONE HURTS!! */
  default:
    debug("Serious screw-up in gasbreath!");
    break;
  }
}
...
void cast_lightning_breath(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break; /* It's a spell.. But people can'c cast it! */
  default:
    debug("Serious screw-up in lightningbreath!");
    break;
  }
}
...
void cast_know_alignment(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in know alignment!");
    break;
  }
}
...
void cast_weakness(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in weakness!");
    break;
  }
}
...
void cast_dispel_magic(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in dispel magic");
    break;
  }
}
...
void cast_animate_dead(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in animate_dead!");
    break;
  }
}
...
void cast_paralyze(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in paralyze");
    break;
  }
}
...
void cast_fear(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in fear");
    break;
  }
}
...
void cast_turn(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in turn");
    break;
  }
}
...
void cast_faerie_fog(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in faerie fog!");
    break;
  }
}
...
void cast_poly_self(byte level, struct char_data *ch, char *arg, int type,
  ...
  default: { debug("Problem in poly_self"); } break;
  }
}
...
void cast_minor_creation(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in minor_create.");
    break;
  }
}
...
void cast_conjure_elemental(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in conjure_elemental.");
    break;
  }
}
...
void cast_cacaodemon(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in cacaodemon.");
    break;
  }
}
...
void cast_mon_sum1(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in monster_summoning_1");
    break;
  }
}
...
void cast_tree_travel(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in tree travel");
    break;
  }
}
...
void cast_speak_with_plants(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("Serious screw-up in speak_with_plants");
    break;
  }
}
...
void cast_transport_via_plant(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("Serious screw-up in transport_via_plant");
    break;
  }
}
...
void cast_haste(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in haste");
    break;
  }
}
...
void cast_slow(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in slow");
    break;
  }
}
...
void cast_reincarnate(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious problem in 'reincarnate'");
    break;
  }
}
...
void cast_changestaff(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in changestaff.");
    break;
  }
}
...
void cast_pword_kill(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in pword_kill.");
    break;
  }
}
...
void cast_pword_blind(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in pword_blind.");
    break;
  }
}
...
void cast_chain_lightn(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in chain lightn.");
    break;
  }
}
...
void cast_scare(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in scare.");
    break;
  }
}
...
void cast_familiar(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("serious screw-up in familiar.");
    break;
  }
}
...
void cast_holyword(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in holy word.");
    break;
  }
}
...
void cast_golem(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in golem.");
    break;
  }
}
...
void cast_command(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    break;
  default:
    debug("serious screw-up in command.");
    return;
    break;
  }
...
void cast_shillelagh(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in shillelagh.");
    break;
  }
}
...
void cast_goodberry(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in goodberry.");
    break;
  }
}
...
void cast_flame_blade(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in flame blade.");
    break;
  }
}
...
void cast_animal_growth(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in animal_growth.");
    break;
  }
}
...
void cast_insect_growth(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in insect_growth.");
    break;
  }
}
...
void cast_creeping_death(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in creeping_death.");
    break;
  }
}
...
void cast_commune(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SCROLL:
    ...
    break;
  default:
    debug("serious screw-up in commune.");
    break;
  }
}
...
void cast_animal_summon_1(byte level, struct char_data *ch, char *arg, int type,
                          struct char_data *tar_ch, struct obj_data *tar_obj) {
  switch (type) {
  case SPELL_TYPE_POTION:
  case SPELL_TYPE_SPELL:
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in animal summon.");
    break;
  }
}

void cast_animal_summon_2(byte level, struct char_data *ch, char *arg, int type,
                          struct char_data *tar_ch, struct obj_data *tar_obj) {
  switch (type) {
  case SPELL_TYPE_POTION:
  case SPELL_TYPE_SPELL:
...
void cast_animal_summon_3(byte level, struct char_data *ch, char *arg, int type,
                          struct char_data *tar_ch, struct obj_data *tar_obj) {
  switch (type) {
  case SPELL_TYPE_POTION:
  case SPELL_TYPE_SPELL:
...
void cast_fire_servant(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in fire servant.");
    break;
  }
}
...
void cast_earth_servant(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in earth servant.");
    break;
  }
}
...
void cast_water_servant(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in water servant.");
    break;
  }
}
...
void cast_wind_servant(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in wind servant.");
    break;
  }
}
...
void cast_veggie_growth(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in veggie_growth.");
    break;
  }
}
...
void cast_charm_veggie(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in charm veggie!");
    break;
  }
}
...
void cast_tree(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("Serious screw-up in tree");
    break;
  }
}
...
void cast_animate_rock(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in animate_rock.");
    break;
  }
}
...
void cast_travelling(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in travelling.");
    break;
  }
}
...
void cast_animal_friendship(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in animal friendship.");
    break;
  }
}
...
void cast_invis_to_animals(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_POTION:
    ...
    break;
  default:
    debug("serious screw-up in invis to animals.");
    break;
  }
}
...
void cast_slow_poison(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in slow_poison.");
    break;
  }
}
...
void cast_entangle(byte level, struct char_data *ch, char *arg, int type,
  ...
  default:
    debug("serious screw-up in entangle.");
    break;
  }
}
...
void cast_snare(byte level, struct char_data *ch, char *arg, int type,
  ...
  default:
    debug("serious screw-up in snare.");
    break;
  }
}
  ...
  case SPELL_TYPE_STAFF:
    for (tar_ch = real_roomp(ch->in_room)->people; tar_ch;
      ...
      if (!in_group(tar_ch, ch))
        spell_barkskin(level, ch, tar_ch, 0);
  default:
    debug("serious screw-up in barkskin.");
    break;
  }
}
...
void cast_warp_weapon(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in warp_weapon.");
    break;
  }
}
...
void cast_heat_stuff(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in heat_stuff.");
    break;
  }
}
...
void cast_sunray(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in sunray.");
    break;
  }
}
...
void cast_find_traps(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in find_traps.");
    break;
  }
}
...
void cast_firestorm(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in firestorm.");
    break;
  }
}
...
void cast_dust_devil(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in dust_devil.");
    break;
  }
}
...
void cast_know_monster(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_WAND:
    ...
    break;
  default:
    debug("serious screw-up in know_monster.");
    break;
  }
}
  ...
  case SPELL_TYPE_STAFF:
    for (tar_ch = real_roomp(ch->in_room)->people; tar_ch;
      ...
      if (!in_group(tar_ch, ch) && !IS_IMMORTAL(tar_ch))
        spell_silence(level, ch, tar_ch, 0);
  default:
    debug("serious screw-up in silence.");
    break;
  }
}
...
void cast_dragon_ride(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in dragon_ride.");
    break;
  }
}
...
void cast_mount(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in mount.");
    break;
  }
}
...
void cast_sending(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("serious screw-up in sending");
    break;
  }
}
...
void cast_portal(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_STAFF:
    ...
    break;
  default:
    debug("serious screw-up in portal");
    break;
  }
}
...
void cast_teleport_wo_error(byte level, struct char_data *ch, char *arg,
  ...
  default:
    debug("Serious screw-up in teleport without error!");
    break;
  }
}
...
void cast_thorn_spray(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in thorn spray!");
    break;
  }
}
...
void cast_resist_hold(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_hold!");
    break;
  }
}
...
void cast_resist_electricity(byte level, struct char_data *ch, char *arg,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_electricity!");
    break;
  }
}
...
void cast_resist_cold(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_cold!");
    break;
  }
}
...
void cast_resist_drain(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_drain!");
    break;
  }
}
...
void cast_resist_poison(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_poison!");
    break;
  }
}
...
void cast_resist_acid(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_acid!");
    break;
  }
}
...
void cast_resist_fire(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_fire!");
    break;
  }
}
...
void cast_resist_energy(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_energy!");
    break;
  }
}
...
void cast_resist_pierce(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_pierce!");
    break;
  }
}
...
void cast_resist_slash(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_slash!");
    break;
  }
}
...
void cast_resist_blunt(byte level, struct char_data *ch, char *arg, int type,
  ...
  case SPELL_TYPE_SPELL:
    ...
    break;
  default:
    debug("Serious screw-up in resist_blunt!");
    break;
  }
}
